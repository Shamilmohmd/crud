...
class _edituserPageState extends State<edituserPage> {
  ...
  void initState() {
    ...
    nameController.text = widget.edit.name.toString();
    emailController.text = widget.edit.email.toString();
    passwordController.text = widget.edit.password.toString();
                              ...
                              actions:[
                                CupertinoDialogAction(
                                  ...
                                  onPressed: () {
                                    ...
                                    // });
                                    //
                                    FirebaseFirestore.instance.collection("user").doc(widget.edit.id).update(
                                      widget.edit.copyWith(email : emailController.text,password : passwordController.text).toMap()
                                    );
